...
//       	console.log("FF");
      ...
      //List all png or jpg or gif file names in the page
      		...
      		var path = dir+filename;
      		$("#row").append('<div class="col-sm-4 fadeInUp wowload"><div class="gallery-items">'+"<img class='img-responsive' src='"+path+ "'alt=item01'/>"+'<div class="caption"><h3>'+filename+'</h3> <a href="'+path+'" title="Digial Agency" class="gallery-image btn btn-default" data-gallery>View Details</a></div></div></div>');
      // $("#row").append( "<img class='img-responsive' src='"+path+ "'alt=item01'/>");
