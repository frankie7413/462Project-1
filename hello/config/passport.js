    ...
    function(req, user, password, done) {
        ...
        User.findOne({ 'local.user' :  user }, function(err, user) {
            ...
            if (user) {
                ...
                newUser.local.firstName = stuff.firstName;
                newUser.local.lastName = stuff.lastName;
    ...
    function(req, user, password, done) { // callback with email and password from our form
        ...
        User.findOne({ 'local.user' :  user }, function(err, user) {
            ...
            if (!user.validPassword(password))
                return done(null, false, req.flash('loginMessage', 'Oh no! Wrong password.')); // create the loginMessage and save it to session as flashdata
